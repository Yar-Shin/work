...
| [Дашборд для компании-оператора игровых аттракционов](https://datalens.yandex/twr5045ls4lki) (продолжаю построение, срок 9.09.23)| Проанализировал динамику выручки, распределение ее по городам, точкам и аттракционам, изучил возвраты и структуру оплат, провел дополнительные расчеты по запросу заказчика|Datalens|
